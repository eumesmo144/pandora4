...
//        this.listinhaDeSenha.adapter = ArrayAdapter<String>(this,android.R.layout.simple_list_item_1,this.caracteres)
        this.listinhaDeSenha.adapter = Senhauncode(this,this.senhas);
    ...
    fun atualizarLista(senha:Senha){
        (this.listinhaDeSenha.adapter as Senhauncode).adicionar(senha)
    }

    fun alterarSenha(novaSenha:Senha,posicao:Int){
        (this.listinhaDeSenha.adapter as Senhauncode).alterarSenha(novaSenha,posicao)
    }

    fun excluirSenha(posicao:Int){
        (this.listinhaDeSenha.adapter as Senhauncode).excluirSenha(posicao)
    }
